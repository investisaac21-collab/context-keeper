...
{/* ONBOARDING CHECKLIST */}
      ...
      {!isPro && projects.length > 0 && (
        <div className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 flex items-center gap-2 text-xs text-gray-500">
          ...
          <span>Historial de versiones · Variables globales · Refinamiento IA · Exportación</span>
          <a href="/pricing" className="ml-auto shrink-0 text-indigo-600 hover:text-indigo-700 font-semibold whitespace-nowrap">Hazte Pro — 9 €/mes &rarr;</a>
        </div>
      )}
