  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen px-6 text-center pt-20">
        ...
        {/* Badge */}
        <div className="relative inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-violet-500/30 bg-violet-500/10 text-violet-300 text-xs font-medium mb-8">
        ...
        <div className="relative mb-10">
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-violet-600 to-blue-600 flex items-center justify-center shadow-2xl shadow-violet-500/30">
            <div className="w-16 h-16 rounded-full bg-[#09090b]/60 flex items-center justify-center">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-400 to-blue-400 animate-pulse" />
            </div>
          </div>
          <div className="absolute -inset-4 rounded-full border border-violet-500/20 animate-ping" style={{animationDuration: '3s'}} />
        </div>

        {/* Headline */}
        <h1 className="relative text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight leading-[1.05] max-w-4xl mb-6">
          Tu IA no recuerda
          <br />
