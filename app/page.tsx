...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white">
      ...
      {/* KEEPER PROFILES â vision futura */}
      <section className="py-24 px-6 border-t border-white/5 fade-section">
        <div className="max-w-5xl mx-auto">
          <p className="text-xs font-semibold tracking-widest text-violet-400 uppercase mb-4 text-center">PrÃ³ximamente â Fase 3</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4 leading-tight">
            Keeper Profiles.<br />
          ...
          <p className="text-white/40 text-center max-w-2xl mx-auto mb-16 text-lg">
            La siguiente capa de Context Keeper. Guarda no solo quÃ© decirle a tu IA, sino quiÃ©n quieres que sea â su tono, sus reglas, su estilo, su comportamiento. Reutilizable. Consistente. Tuyo.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            {[
              { icon: '&#128187;', label: 'ProgramaciÃ³n', title: 'Asistente por stack', desc: 'Memoria de arquitectura, reglas de cÃ³digo, contexto tÃ©cnico persistente por repositorio.' },
              { icon: '&#9997;&#65039;', label: 'Creatividad', title: 'Personajes con voz', desc: 'Tono, lore, forma de hablar. Tu personaje responde igual en cada sesiÃ³n.' },
              { icon: '&#128200;', label: 'Marcas', title: 'Voz de marca persistente', desc: 'Brief, estilo, palabras clave. Tu asistente de comunicaciÃ³n siempre en caracter.' },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
            ...
            <div className="p-6 rounded-2xl border border-violet-500/30 bg-violet-500/5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs text-white/30 bg-white/5 px-2 py-0.5 rounded-full">PrÃ³ximamente</span>
              </div>
              <p className="text-white/40 text-sm leading-relaxed">Personalidad, tono, reglas, comportamiento. QuiÃ©n es tu IA para este proyecto â de forma persistente y reutilizable.</p>
            </div>
          </div>
          ...
          <div className="mt-14 max-w-sm mx-auto">
            <div className="text-center mb-4">
              <span className="text-xs text-white/30 uppercase tracking-widest">AsÃ­ se verÃ¡ un Keeper Profile</span>
            </div>
            <div className="rounded-2xl border border-violet-500/30 bg-gradient-to-br from-violet-950/40 to-[#111113] p-6 shadow-xl shadow-violet-500/10 relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <div className="text-violet-400 text-xs">Keeper Profile Â· Pro</div>
                </div>
